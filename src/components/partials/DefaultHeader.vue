        ...
        <div class="container">
            ...
            <div class="mb-2">
                <div class="d-flex align-items-center">
                    <div class="text-center d-none d-sm-block col-sm-3 ">
                        <a href="/" class="fs-1 header__navbar-item">Evalley</a>
                    </div>
